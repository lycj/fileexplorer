...
namespace Cinch
{
    ...
    public class SimpleCommand : ICommand
    {
        ...
        /// </summary>
        public Action<object> ExecuteDelegate { get { return _executeDelegate; }
            set { if (_executeDelegate != null && Debugger.IsAttached) Debugger.Break(); _executeDelegate = value; }
        }
        #endregion
        ...
        private long unique = count++;

        public override string ToString()
        {
            return base.ToString() + " - " + unique.ToString();
        }
