...
namespace FileExplorer.Scripting
{
    ...
    public static partial class ScriptCommands
    {
        ...
        /// <param name="nextCommand"></param>
        /// <returns></returns>
        public static IScriptCommand GetProperty(string sourceObjectVariable = "{Source}",
            ...
            string destinationVariable = "{Destination}", IScriptCommand nextCommand = null)
        {
            ...
            return AssignValueConverter(ValueConverterType.GetProperty, valueConverterVariable,
                ScriptCommands.Reassign(sourceObjectVariable, valueConverterVariable,
                    destinationVariable, nextCommand), propertyName);
        }
        ...
        /// <param name="nextCommand"></param>
        /// <returns></returns>
        public static IScriptCommand GetProperty<C, T>(string sourceObjectVariable = "{Source}",
            ...
            string destinationVariable = "{Destination}", IScriptCommand nextCommand = null)
        {
            ...
            return GetProperty(sourceObjectVariable, property, destinationVariable, nextCommand);
        }
        ...
        {
            string valueConverterVariable = ParameterDicUtils.CombineVariable(sourceObjectVariable, "Converter");
            string valueVariable = ParameterDicUtils.CombineVariable(sourceObjectVariable, "Value");
            return
                Assign(valueVariable, value, 
    ...
    public class AssignValueConverter : Assign
    {
        ...
        private static ILog logger = LogManager.GetLogger<AssignValueConverter>();
